...
def handle_form_submission():
    ...
    with open(csv_file_path, 'a', newline='') as csvfile:
        fieldnames = ['project_name', 'city', 'total_number_project', 'total_cost', 'start_date', 'end_date', 'value_first_trimester', 'value_second_trimester', 'value_third_trimester', 'value_fourth_trimester']
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
        
        # Assuming form data keys are consistent with CSV column names
        writer.writerow(form_data)
    
    # Return a success response
    return jsonify({"message": "Data successfully added to CSV"})
